...
<form name="CheckComplainForm">
    <div style="margin-left: 150px">
        <label style="color: burlywood;"><h2>查看公告信息</h2></label>
    </div>
    <div style="margin-left: 100px">
        <hr width="1000px" align="left">
    </div>
    <div style="margin-top: 70px;margin-left: 340px">
        <b>请输入日期：</b><input type="text" name="noticeDate">&nbsp&nbsp&nbsp&nbsp<input type="image" src="/ZxMgrSys/images/img111.png" style="width: 90px;height: 29px " value="查询" onclick="this.form.submit()">
    </div>
    <table style="margin-top: 30px;margin-left: 300px" border="1">
        ...
        <tr>
            ...
            <td width="100px"align="center">
                <input type="button" value="删除" style="background-color:lightsteelblue;width: 79px;height: 34px ">
            </td>
        </tr>
    </table>

...
<form name="CheckVisitInfForm" id="CheckVisitInfForm" method="post" action="VisitServlet?action=queryVisitByButton" onsubmit="return vaildate(this)">
    ...
    <div style="margin-top: 70px;margin-left: 340px">
        <b>请输入查询日期：</b><input type="text" name="visitDate" id="visitDate" value="<%=selectTime%>">&nbsp&nbsp&nbsp&nbsp<input type="image" src="/ZxMgrSys/images/img111.png" style="width: 90px;height: 29px " name="query" id="query" value="查询">
    </div>
    <table style="margin-top: 30px;margin-left: 300px" border="1">
        ...
        <tr>
            ...
            <td width="200px"align="center"><input type="button" id="<%=visiterList.get(i).getVisit_ID() %>" value="删除" onclick="toDelete(this)"style="background-color:lightsteelblue;width: 79px;height: 34px "></td>
        </tr>
        <%
			}
		}
        ...
        <tr>
           <td width="810px" align="center">
               <input type="image" src="/ZxMgrSys/images/img116.png" style="width: 90px;height: 29px " id="before" value="上一页" onclick="onePage(this)">
                ...
                &nbsp;&nbsp;
               <input type="image" src="/ZxMgrSys/images/img117.png" style="width: 90px;height: 29px " id="behind" value="下一页" onclick="onePage(this)">
...
<script type="text/javascript">
	...
	function toDelete(b){
		var myform=document.getElementById("CheckVisitInfForm");
		if(vaildate(myform)){
			myform.action="VisitServlet?action=deleteVisit&visit_ID="+b.id;
			myform.submit();
		}
	}

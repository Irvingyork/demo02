...
<body>
<form name="DengjiInfForm" action="<%=request.getContextPath()%>/OfficeServlet?action=6" method="post">
    ...
    <table style="margin-top: 10px;margin-left: 300px">
        ...
        <tr>
            ...
            <td>
                <select name="power" >
                    <option  value="1" selected>业主</option>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="roomNumber" name="roomNumber" value="${requestScope.room.getRoom_Number() }" readonly/>
            </td>
        </tr>
        <tr>
            <td height="76px">
            ...
            <td>
                <input type="text" id="startTime" name="startTime" onblur="validate(this.id)" onfocus="assignull(this.id)"/>
            </td>
        </tr>
        <tr>
            <td height="76px">
            ...
            <td>
                <input type="text" id="endTime" name="endTime" onblur="validate(this.id)" onfocus="assignull(this.id)"/>
            </td>
        </tr>
    </table>
    <table style="margin-top: 30px">
        <tr>
             <td width="850px" align="center">
                <input type="image" src="/ZxMgrSys/images/img118.png" value="修改" style="width: 90px;height: 29px " onclick="this.form.submit()">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="image" value="重置" src="/ZxMgrSys/images/img112.png" style="width: 90px;height: 29px "onclick="this.form.reset()">
            </td>
        </tr>
    </table>
</form>

...
<form name="CheckComplainForm">
    ...
    <div style="margin-top: 70px;margin-left: 340px">
        <b>请输入日期：</b><input type="text" name="complainDate">&nbsp&nbsp&nbsp&nbsp<input type="image" src="/ZxMgrSys/images/img111.png" value="修改" style="width: 90px;height: 29px " name="query" id="query" value="查询" onclick="this.form.submit()">
    </div>

...
function minuspage(){
	...
	page--;
	window.location.href="RoomServlet?action=5&page="+page;
	}
...
<form action="<%=request.getContextPath()%>/RoomServlet?action=5" method="post">
<div style="margin-left: 150px">
    <label style="color: burlywood;"><h2>查看空房信息</h2></label>
</div>
<div style="margin-left: 100px">
    <hr width="1000px" align="left">
</div>
<!--  <div style="margin-top: 70px;margin-left: 340px">
    <b>请输入查询房间号：</b><input type="text" name="roomNumber">&nbsp&nbsp&nbsp&nbsp<input type="submit" value="查询">
</div>-->
<table style="margin-top: 50px;margin-left: 100px" border="1">
  ...
  %>
    <tr>
        ...
        <td>
           <input type="button" onclick="window.location.href='<%=request.getContextPath()%>/OfficeServlet?action=7&roomnum=<%=room.getRoom_Number()%>'" value="登记入住" style="background-color:lightsteelblue;width: 70px;height: 25px ">
        </td>
    </tr>
    <%}
	  } %>

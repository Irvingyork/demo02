...
<form name="AddUserInfForm">
    ...
    <table style="margin-top: 10px;margin-left: 300px">
        ...
        <tr>
            ...
            <td>
                <input type="text" id="phone" name="phone" onblur="validate(this.id)" onfocus="assignull(this.id)"/>
            </td>
        </tr>
        <tr>
            <td height="76px">
        ...
        <tr>
            ...
            <td>
                <select>
                    <option name="power" value="">业主</option>
                    <option>管理员</option>
                    <option>安保人员</option>
                </select>
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="parkNumber" name="parkNumber"onblur="validate(this.id)" onfocus="assignull(this.id)"/>
            </td>
        </tr>
    </table>

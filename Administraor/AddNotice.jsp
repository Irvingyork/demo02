...
<form name="AddNoticeForm">
    ...
    <table style="margin-top: 30px;margin-left: 300px">
        ...
        <tr>
            <td>
               <textarea name="notice" style="width:600px;height: 300px;border-style:solid ;border-color:black" onblur="validate(this.id)" onfocus="assignull(this.id)">
            </textarea>
            </td>
        </tr>
    </table>
